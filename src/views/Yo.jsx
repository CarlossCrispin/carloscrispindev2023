...
const Yo = () => {
  return (
    <div className="p-2 -screen md:p-8" id="yo">
      <div className='flex flex-col-reverse items-center justify-between h-full grid-cols-1 gap-2 lg:grid md:grid-cols-3'>
        <div className="justify-center col-span-2 p-8 mt-12 tracking-wide text-justify md:px-24 text-md md:text-3xl">
