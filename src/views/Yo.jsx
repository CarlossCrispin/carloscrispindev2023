    ...
    <div className="h-screen p-2 md:p-8" id="yo">
      <div className="shadow-xl dark:bg-slate-900 bg-slate-50 rounded-xl">
        <div className='grid items-center justify-between h-full grid-cols-2 gap-2'>
          ...
          <div className='flex items-center justify-center'><h1 className="text-4xl md:text-7xl text-brown-400">¡Hola! Soy <span className="text-brown-700">Carlos <span className="text-brown-800">Crispin</span></span></h1></div>
        </div>
